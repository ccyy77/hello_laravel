...
/* header.twig */
class __TwigTemplate_ae012ae95bc82f72286b086ba85ed0796da1657bb0eb25cf660acbc2d3fe1de2 extends Template
{
    private $source;
    private $macros = [];
...
<head>
  ...
  ";
    ...
    <link rel=\"stylesheet\" type=\"text/css\" href=\"";
                ...
                echo twig_escape_filter($this->env, ($context["theme_path"] ?? null), "html", null, true);
                echo "/css/theme";
                echo (((0 === twig_compare(($context["text_dir"] ?? null), "rtl"))) ? ("-rtl") : (""));
                echo ".css?";
                echo twig_escape_filter($this->env, ($context["version"] ?? null), "html", null, true);
                echo "&nocache=";
                // line 25
...
<body";
  ...
  ";
            // line 47
            if ((($context["is_menu_enabled"] ?? null) && (1 === twig_compare(($context["server"] ?? null), 0)))) {
                // line 48
                echo "    ";
...
";
    ...
    {
        return new Source("", "header.twig", "/home/vagrant/code/public/mp/templates/header.twig");
    }
}
