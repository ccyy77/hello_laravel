...
class __TwigTemplate_644d42d881dd675162c92da04cfcb3907f7c2ca788534501317c0193ee9b7350 extends Template
{
    private $source;
    private $macros = [];
  ...
  <tr>
    ...
    ";
        // line 7
        if ((1 === twig_compare(($context["number_total_page"] ?? null), 1))) {
            // line 8
...
($context["session_max_rows"] ?? null), "pos" => "0"]));
    ...
    <td class=\"navigation_goto\">
      ";
        ...
        echo "', 0";
        // line 46
        (((1 === twig_compare(($context["unlim_num_rows"] ?? null), 0))) ? (print (twig_escape_filter($this->env, (", " . (($context["unlim_num_rows"] ?? null) - 1)), "html", null, true))) : (print ("")));
        // line 47
        echo "));\">
...
";
    ...
    {
        return new Source("", "display/results/table_navigation.twig", "/home/vagrant/code/public/mp/templates/display/results/table_navigation.twig");
    }
}
